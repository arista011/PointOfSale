...
class Pemasok extends BaseController
{
    ...
    public function tambah()
    {
        if ($this->request->isAJAX()) {
            if (!$this->validate($this->rules)) {
                ...
                // sukses
                $data = [
                    'nama_pemasok'     => ucwords($this->request->getPost('pemasok')),
                    'telp_pemasok'     => $this->request->getPost('telp'),
                    'alamat_pemasok'   => ucwords($this->request->getPost('alamat')),
    ...
    public function hapus()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = $this->pemasokModel->find($id);
            if (!(empty($data))) {
